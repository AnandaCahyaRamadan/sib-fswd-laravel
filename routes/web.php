...
Route::post('/products/store', [\App\Http\Controllers\ProductController::class, 'store'])->middleware('auth','admin')->name('products.store');
...
Route::get('/sliders/create', [\App\Http\Controllers\SliderController::class, 'create'])->middleware('auth','admin')->name('sliders.create');
